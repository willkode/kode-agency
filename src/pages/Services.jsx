...
import { 
  ...
  ArrowRight, CheckCircle, Phone, Zap, Stethoscope, Package, Smartphone, GitBranch, ArrowRightLeft, Shield
} from 'lucide-react';
...
export default function ServicesPage() {
  ...
  const specialtyServices = [
    ...
    { icon: Shield, title: "Security Check", slug: "SecurityCheck", desc: "Professional security audit for your Base44 app. Get a detailed security report for just $20." },
