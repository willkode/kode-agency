  ...
  return (
    <div className="flex flex-col bg-slate-950 text-white overflow-hidden">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        ...
        <div className="absolute top-10 right-[15%] text-lime-400 animate-spin-slow hidden md:block">
      ...
      <Section className="py-24">
         <div className="text-center mb-16">
            <div className="text-lime-400 text-sm font-bold uppercase tracking-wider mb-2">Best Of Service</div>
         ...
         <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
               {[
                  ...
                  <div key={i} className="bg-slate-900 border border-slate-800 p-8 rounded-xl text-center hover:border-lime-400 transition-all duration-300 group">
                     <div className="w-12 h-12 mx-auto mb-6 text-slate-400 group-hover:text-lime-400 transition-colors">
                     ...
                     <button className="w-10 h-10 rounded-full border border-slate-700 flex items-center justify-center mx-auto text-slate-400 hover:bg-lime-400 hover:border-lime-400 hover:text-black transition-all">
         ...
         <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-16 items-center">
               ...
               <div className="relative">
                  ...
                  <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-0 h-0 border-l-[30px] border-l-transparent border-r-[30px] border-r-transparent border-b-[50px] border-b-lime-400 transform rotate-12"></div>
               </div>

               {/* Right: Text Content */}
               <div>
                  <div className="flex items-center gap-2 text-lime-400 text-sm font-bold uppercase tracking-wider mb-2">
                     <span className="w-2 h-2 bg-lime-400 rounded-full"></span> Team Member
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 border border-slate-800 rounded-lg bg-slate-900/50 w-fit">
                     ...
                     <div>
                        ...
                        <span className="text-lime-400 font-bold">+00 (9900) 666 22</span>
                     </div>
                  </div>
               </div>
            </div>
      ...
      <Section className="py-24 bg-slate-900/20">
         <div className="text-center mb-16">
            <div className="text-lime-400 text-sm font-bold uppercase tracking-wider mb-2">Team Member</div>
                  ...
                  <div key={i} className="group relative overflow-hidden rounded-xl">
                     ...
                     <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-6 pt-20 flex justify-between items-end">
                        ...
                        <div className="flex gap-2 opacity-0 group-hover:opacity-100 transition-opacity transform translate-x-2 group-hover:translate-x-0 duration-300">
                           <button className="bg-lime-400 p-1.5 rounded hover:bg-white transition-colors"><Twitter className="w-3 h-3 text-black" /></button>
                        </div>
                     </div>
                  </div>
               ))}
      ...
      <Section className="py-24">
         <div className="text-center mb-16">
            <div className="text-lime-400 text-sm font-bold uppercase tracking-wider mb-2">What's Clients Say</div>
         ...
         <div className="container mx-auto px-4">
            <div className="grid md:grid-cols-3 gap-8">
               {[
                  ...
                  <div key={i} className="bg-slate-900 border border-slate-800 p-8 rounded-xl relative group hover:border-lime-400/30 transition-colors">
                     {/* Stars */}
                     ...
                     <div className="flex items-center justify-between border-t border-slate-800 pt-6">
                        ...
                        <div className="w-8 h-8 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 group-hover:bg-lime-400 group-hover:text-black transition-colors">
                           <Quote className="w-3 h-3 fill-current" />
                        </div>
                     </div>
                     
                     {/* Green Quote Icon Top Right */}
                     <div className="absolute top-8 right-8 text-lime-400 opacity-20">
            ...
            <div className="relative z-10 w-full md:w-auto flex gap-2">
               <div className="relative w-full md:w-80">
                  <input 
                     ...
                     className="bg-slate-950 border-b border-slate-800 w-full px-0 py-4 text-white focus:outline-none focus:border-lime-400 bg-transparent"
                  />
               </div>
               <button className="w-20 h-20 bg-lime-400 rounded-full flex flex-col items-center justify-center text-black font-bold text-xs hover:scale-105 transition-transform shadow-lg shadow-lime-400/20">
