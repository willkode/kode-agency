...
import { Search, ExternalLink, Mail, Calendar, DollarSign, Trash2, CheckCircle, Copy, Layers, Target, Send, Loader2 } from 'lucide-react';
...
export default function AppFoundationSection() {
