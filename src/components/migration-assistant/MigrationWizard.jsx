...
const STEPS = ['Project Intake', 'Hosting Target', 'Host Presets', 'Health System', 'App Config', 'Generated Outputs'];
...
export default function MigrationWizard({ onReset, projectId, existingProfileId }) {
  ...
  const canProceed = () => {
    ...
    if (step === 4) return !!profile.app_name && !!profile.base44_api_base_url && !!profile.frontend_domain;
    return true;
  };
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <Card className="p-8 bg-slate-900/80 border-slate-700">
        ...
        {step === 4 && <StepAppConfig profile={profile} onChange={updateProfile} />}
        {step === 5 && <StepOutputs profile={profile} />}
      </Card>
