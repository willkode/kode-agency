    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <Card className="p-8 bg-slate-900/80 border-slate-700">
        <div className="prose prose-invert prose-slate max-w-none
          ...
          prose-h1:text-2xl prose-h1:font-bold prose-h1:border-b prose-h1:border-slate-700 prose-h1:pb-3 prose-h1:mb-6 prose-h1:mt-8
          prose-h2:text-xl prose-h2:font-bold prose-h2:text-[#73e28a] prose-h2:mt-10 prose-h2:mb-4
          prose-h3:text-base prose-h3:font-bold prose-h3:text-slate-200 prose-h3:mt-6 prose-h3:mb-3
          prose-p:text-slate-400 prose-p:leading-relaxed prose-p:mb-4
          prose-li:text-slate-400 prose-li:mb-1
          ...
          prose-pre:bg-slate-800 prose-pre:border prose-pre:border-slate-700 prose-pre:mb-6 prose-pre:mt-4
          prose-blockquote:border-l-[#73e28a] prose-blockquote:text-slate-400 prose-blockquote:my-6
