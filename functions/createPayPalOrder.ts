  ...
  try {
    ...
    const orderResponse = await fetch(`${PAYPAL_API}/v2/checkout/orders`, {
      ...
      body: JSON.stringify({
        ...
        application_context: {
          brand_name: 'Kode Agency - Base44 ER',
          landing_page: 'NO_PREFERENCE',
          user_action: 'PAY_NOW',
          return_url: `${req.headers.get('origin')}/Base44ER?success=true&requestId=${requestId}`,
          cancel_url: `${req.headers.get('origin')}/Base44ER?cancelled=true`,
        },
      }),
    });
